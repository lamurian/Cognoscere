...
5. Create with `create_para_doc` or `batch_create_para_docs` following the [create-doc skill's standards](.agents/skills/create-doc/SKILL.md) for content structure, citation format, and math syntax.
...
> **Document creation authority:** All PARA documents must follow the specifications in the [create-doc skill](.agents/skills/create-doc/SKILL.md). This is the single reference for atomic principle, language, citation style, math syntax, cross-referencing, and classification.
