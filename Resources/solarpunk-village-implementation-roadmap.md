...
## Phase 0: Ideation & Core Formation (Year 0 – 6 months)
...
## Phase 2: Seed Village (Year 1–3)

**Goal**: Build first homes, start food production, establish governance.

- **Population**: Grow from 5–15 to 20–40
- **Buildings**: 2–4 homes (natural or green building), a common house, first workshop
- **Energy**: Solar PV + battery for common house; individual homes add solar as built
- **Water**: Rainwater catchment system, composting toilets, greywater wetland
- **Food**: Establish market garden (1–2 acres), fruit trees, poultry
...
## Phase 3: Growing Village (Year 3–5)

**Goal**: Reach critical mass for division of labour.
...
## Phase 4: Stable Village (Year 5–10)

**Goal**: Full-featured, resilient solarpunk community.
...
## Phase 5: Maturity & Regeneration (Year 10+)

**Goal**: Thriving demonstration of solarpunk living.

- Self-sustaining governance (can survive member turnover)
- Net-positive ecology (more biodiversity than on arrival)
- Active education centre training the next wave of solarpunks
- Regional influence (policy, supply chains, culture)
- Potential to seed new villages (daughter communities)

---

## Critical Success Factors

From Kasper (2008) and Lockyer (2018), the factors that distinguish thriving ecovillages from failing ones:
...
- [[solarpunk-a-vision-for-a-sustainable-future]] — the solarpunk vision that this roadmap is designed to realise
