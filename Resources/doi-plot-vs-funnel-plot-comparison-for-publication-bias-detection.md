...
|---|---|---|
| **Inventor / Year** | Light &amp; Pillemer (1984); formalised by Egger et al. (1997) | Furuya-Kanamori, Barendregt &amp; Doi (2018) [@furuyakanamori2018] |
...
| **Performance (sensitivity)** | Egger's test: 18.5-43.0% sensitivity in simulations (5-20 studies) [@furuyakanamori2018] | LFK index: 71.3-72.1% sensitivity in same simulations [@furuyakanamori2018] |
| **Performance (AUC)** | Egger's AUC: 0.58-0.75 across simulations [@furuyakanamori2018] | LFK index AUC: 0.74-0.88 across simulations [@furuyakanamori2018] |
