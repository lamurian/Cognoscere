...
For homestead safety, Meshtastic enables communication during power outages, floods, or storms when cell towers are down. It also serves as an emergency notification system — one node can broadcast an alert to all others on the property instantly [@espressifsystems2024].