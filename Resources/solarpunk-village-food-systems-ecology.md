...
- Integrates animals (rotational grazing mimics natural herd movement)
- Creates habitat (polycultures, hedgerows, insect corridors)
- Minimises external inputs (closed-loop fertility from compost, animal manure, humanure)

## Food Production Zones

Using permaculture zone planning:

| Zone | Distance | Use | Examples |
|------|----------|-----|----------|
| **Zone 0** | The home | Kitchen garden, herbs | Salad greens, tomatoes, culinary herbs |
| **Zone 1** | Near homes | Intensive market garden | Vegetables, berries, mushrooms |
...
|-------|---------------------------|-------------|
| >50% food from site | 1 of 8 | Achieved through high communalism (shared income, shared kitchens) |
| 21–50% | 1 of 8 | Maturing permaculture systems |
| 6–20% | 2 of 8 | Perennial systems producing, gardens established |
| 1–5% | 3 of 8 | Early-stage or less intensive food production |
| None | 1 of 8 | Just starting |

The median solarpunk village should expect ~1–20% food self-sufficiency in the first 3–5 years, ramping to 20–50% by year 8–10. Complete self-sufficiency is rare — most ecovillages remain connected to regional food systems.
...
Animal agriculture is handled differently based on community ethics:
