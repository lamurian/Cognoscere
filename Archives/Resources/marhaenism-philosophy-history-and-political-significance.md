...
The economic model is production for use, not profit:
...
Marhaenism was articulated through Sukarno's broader ideological framework:

| Component | Description |
|-----------|-------------|
| **Pancasila** | The five principles: Belief in God, Just/Civilised Humanity, National Unity, Democracy through Deliberation, Social Justice |
| **Nasakom** | Unity of Nationalists, Religious groups, and Communists |
...
### Phase 1: Formulation (1920s–1945)

Sukarno developed Marhaenism during the nationalist movement against Dutch colonialism. The 1930 *Indonesia Accuses* speech was its first major public articulation. During the Japanese occupation (1942–1945) and the subsequent independence struggle, Marhaenism became the ideological glue for the nationalist movement.

### Phase 2: Implementation Attempt (1945–1957)

After independence, Indonesia experimented with parliamentary democracy (1950–1957). Marhaenism guided the PNI's platform but could not be implemented due to coalition politics, regional rebellions, and economic chaos. This period saw seven cabinets in seven years.
...
- Withdrawal from the UN (1965)
- Close alignment with China (Jakarta-Peking Axis)
...
The New Order regime under Suharto purged Marhaenism along with the PKI. A depoliticised version of Pancasila was imposed as the sole state ideology. Marhaenism survived only as a minor current in the PNI (which was forced to merge into the Indonesian Democratic Party, PDI) and later through Megawati Sukarnoputri's PDI-P.

### Phase 6: Contemporary Legacy (1998–present)
...
| Dimension | Marhaenism | Marxism | Social Democracy |
|-----------|-----------|---------|-----------------|
| **Revolutionary subject** | Marhaen (smallholder/artisan) | Proletariat (industrial worker) | The electorate |
| **Ownership** | Small-scale private ownership of means of production | Socialisation of means of production | Mixed economy with welfare state |
| **Class analysis** | Anti-imperialist + anti-capitalist | Anti-capitalist (class struggle) | Redistribution within capitalism |
| **Approach to religion** | Accommodating/integrating (Nasakom) | Atheistic/secular | Secular |
| **Economic goal** | Self-sufficiency first, surplus second | Abolition of exploitation | Growth + redistribution |

---

## Criticisms

1. **Populism over analysis** — Critics argue Marhaenism is more a rhetorical/populist tool than a rigorous economic framework
2. **Dependence on Sukarno** — The ideology was inseparable from Sukarno's personal charisma and collapsed without him
3. **Impractical economic policies** — Guided Democracy's nationalisations and confrontation policies led to hyperinflation (600+%) and economic collapse by 1965
4. **Authoritarian tendencies** — Guided Democracy suppressed political parties, controlled the press, and concentrated power in the presidency
5. **Class ambiguity** — The "Marhaen" category is so broad (anyone who is poor but owns something) that it lacks analytical precision
